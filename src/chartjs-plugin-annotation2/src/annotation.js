...
import { handleEvent, handleMouseDown, hooks, updateListeners } from "./events";
import $ from "jquery";
...
const Annotation2 = {
   ...
   beforeEvent(chart, args, options) {
      ...
      $("#canvas").mousedown(function (e) {
         handleMouseDown(chart, state, options);
      });
   ...
   descriptors: {
      ...
      annotations: {
         _allKeys: false,
         _fallback: (prop, opts) => `elements.${annotationTypes[opts.type || "box"].id}`
      }
   },
